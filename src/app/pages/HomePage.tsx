    ...
    >
      ...
      <section ref={projectsRef} className="scroll-mt-4 px-6 py-16 sm:px-8 lg:px-12 lg:py-20">
        <div className="mx-auto max-w-[1180px]">
          <p className="mb-7 font-mono text-xs uppercase tracking-[0.15em] text-[#9EB1C4]">
            Selected Projects
          </p>
            ...
            {projects.map((project) => (
              ...
              >
                <div className="flex flex-col sm:flex-row">
                  <div className="h-52 flex-shrink-0 overflow-hidden border-b border-[#6AA3D8]/15 bg-[#031D31]/70 sm:h-auto sm:w-72 sm:border-b-0 sm:border-r">
                    <img
                      src={project.image}
                      alt={`Temporary placeholder for ${project.name}`}
                      className="h-full min-h-[180px] w-full object-cover opacity-85 transition-all duration-500 group-hover:scale-[1.02] group-hover:opacity-100"
                    />
                  </div>
